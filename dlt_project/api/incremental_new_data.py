"""
Améliorons notre exemple d'API GitHub et obtenons uniquement
les problèmes créés depuis le dernier chargement.
Au lieu d'utiliser replacela disposition en écriture et de télécharger tous les tickets à chaque exécution du pipeline.
"""
